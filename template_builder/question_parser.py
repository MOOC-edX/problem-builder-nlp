...
def parse_question_v2(question_text):
    ...
    # Filter numeric variables from list_pos
    variables = []
    ...
    print "numeric variables= {}".format(variables)
    ...
    for i in range(len(variables)):
        ...
        print "i = {}, numeric_variables= {}".format(str(i), numeric_variables)
    ...
    print "AFTER join words, question_template = {}".format(question_template)
    # for variable in string_variables:
    #      question_template = re.sub(" {} ".format(variable["default"]), " [{}] ".format(variable["name"]), question_template )

    # use dict instead of list of dict for string variables
...
if __name__ == '__main__':
    ...
    ex1 = """Given 7 apples and 5 pearls . One apple cost 4 cents, one pearl cost 3 cents. Calculate the total money spent for them?"""
    ans1 = """x = 7 * 4 + 5 * 3"""

    question_template, numeric_variables, string_variables = parse_question_v2(ex1)
    #noun = parse_noun(ex1)
    answer_template = parse_answer_v2(ans1, numeric_variables)
