...
function StudioEditableXBlockMixin(runtime, xblockElement) {
    ...
    var studio_buttons = {
//        "question_original-tab": "TEMPLATE BUILDER",
...
//        }
        ...
        $('.editor-modes')
                .append(
                    $('<li>', {class: "action-item"}).append(
                        $('<a />', {class: "action-primary", id: 'question_original-tab', text: studio_buttons['question_original-tab']})
                    )
                );
...
//        $('#question_original-tab').click(function() {
//            tab_switch("question_original-tab");
//        });
